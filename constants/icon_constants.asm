; IconPointers indexes (see data/icon_pointers.asm)
	...
	const ICON_PANGOLOW    ; PANGOLOW
	const ICON_PANGNITE    ; PANGNITE
	const ICON_PANGARMA    ; CHARIZARD
	...
	const ICON_STRAIKIT      ; STRAIKIT
	const ICON_NYAMPOSTOR      ; NYAMPOSTOR
	const ICON_CHICKUB    ; CHICKUB
	const ICON_AVIANZU      ; AVIANZU
	const ICON_AVIARID   ; AVIARID
