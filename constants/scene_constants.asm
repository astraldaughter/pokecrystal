...
; wRoute51SceneID
	const_def
	const SCENE_ROUTE51_NOTHING        ; 0
	const SCENE_ROUTE51_CATCH_TUTORIAL ; 1

; wCampanulaTownSceneID
	const_def
	const SCENE_CAMPANULATOWN_NOTHING    ; 0
	const SCENE_CAMPANULATOWN_MEET_RIVAL ; 1
