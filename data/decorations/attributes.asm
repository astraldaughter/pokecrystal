...
; entries correspond to deco constants
	...
	decoration DECO_DOLL,    PANGOLOW,        SET_UP_DOLL,       EVENT_DECO_CHARMANDER_DOLL,         SPRITE_PANGOLOW
	...
	decoration DECO_DOLL,    STRAIKIT,        SET_UP_DOLL,       EVENT_DECO_WEEDLE_DOLL,             SPRITE_WEEDLE
