...
.ko_go:    db MAGIKARP, MAGNEMITE, GASTLY, HAUNTER, MACHOKE, NYAMPOSTOR, PSYDUCK, PHANPY, RATTATA, GOLDUCK, GOLBAT, GOLEM, GRAVELER, VENONAT, -1
...
.su_zu:    db SUICUNE, STARMIE, SCYTHER, ZUBAT, CHICKUB, HYPNO, DROWZEE, -1
...
.hi_bi_pi: db CLEFFA, STRAIKIT, PIKACHU, CLEFABLE, PIDGEOT, AVIARID, PICHU, CLEFAIRY, PANGOLOW, STARYU, CYNDAQUIL, SUNKERN, TEDDIURSA, VOLTORB, -1
...
.ho_bo_po: db HO_OH, HOOTHOOT, AVIANZU, PONYTA, SKIPLOOM, PORYGON, PORYGON2, -1
...
.ri:       db PANGNITE, PANGARMA, URSARING, -1
.ru:       db JYNX, LUGIA, -1
