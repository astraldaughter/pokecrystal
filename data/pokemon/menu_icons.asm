...
MonMenuIcons:
	...
	db ICON_PANGOLOW  ; PANGOLOW
	db ICON_PANGNITE  ; PANGNITE
	db ICON_PANGARMA   ; PANGARMA
	...
	db ICON_STRAIKIT      ; STRAIKIT
	db ICON_NYAMPOSTOR      ; NYAMPOSTOR
	db ICON_CHICKUB    ; CHICKUB
	db ICON_AVIANZU      ; AVIANZU
	db ICON_AVIARID   ; AVIARID
