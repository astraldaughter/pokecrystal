...
FalknerGroup:
	...
	db  7, AVIANZU,     TACKLE, MUD_SLAP, NO_MOVE, NO_MOVE
	db  9, AVIARID,  TACKLE, MUD_SLAP, GUST, NO_MOVE
	db -1 ; end
...
BugsyGroup:
	...
	db 14, NYAMPOSTOR,     POISON_STING, STRING_SHOT, HARDEN, NO_MOVE
...
ChampionGroup:
	...
	db 46, PANGARMA,   FLAMETHROWER, WING_ATTACK, SLASH, HYPER_BEAM
...
CooltrainerMGroup:
	...
	db 26, PANGOLOW, EMBER, SMOKESCREEN, RAGE, SCARY_FACE
	...
	db 27, PANGNITE, EMBER, SMOKESCREEN, RAGE, SCARY_FACE
	db -1 ; end
...
BugCatcherGroup:
	...
	db 25, CHICKUB,   FURY_ATTACK, FOCUS_ENERGY, TWINEEDLE, RAGE
	...
	db 32, CHICKUB,   FURY_ATTACK, PURSUIT, TWINEEDLE, DOUBLE_TEAM
...
RedGroup:
	...
	db 77, PANGARMA,   FLAMETHROWER, WING_ATTACK, SLASH, FIRE_SPIN
