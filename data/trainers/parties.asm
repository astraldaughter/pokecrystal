...
CooltrainerMGroup:
	...
	db 37, DRAGONAIR,  WRAP, SURF, DRAGON_DANCE, SLAM
	db -1 ; end
...
SwimmerFGroup:
	...
	db 21, HORSEA,     DRAGON_DANCE, SMOKESCREEN, LEER, WATER_GUN
	db -1 ; end
...
BlackbeltGroup:
	...
	db 27, HITMONLEE,  DOUBLE_KICK, CALM_MIND, JUMP_KICK, FOCUS_ENERGY
	db -1 ; end
