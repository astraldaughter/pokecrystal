...
CampanulaTown_MapScripts:
	def_scene_scripts
	scene_script .DummyScene0 ; SCENE_CAMPANULATOWN_NOTHING
	scene_script .DummyScene1 ; SCENE_CAMPANULATOWN_MEET_RIVAL
...
CherrygroveSilverSceneSouth:
	moveobject CAMPANULATOWN_SILVER, 39, 7
CherrygroveSilverSceneNorth:
	turnobject PLAYER, RIGHT
	showemote EMOTE_SHOCK, PLAYER, 15
	special FadeOutMusic
	pause 15
	appear CAMPANULATOWN_SILVER
	applymovement CAMPANULATOWN_SILVER, CampanulaTown_RivalWalksToYou
	turnobject PLAYER, RIGHT
	...
	setlasttalked CAMPANULATOWN_SILVER
...
.FinishRival:
	...
	turnobject PLAYER, LEFT
	applymovement CAMPANULATOWN_SILVER, CampanulaTown_RivalExitsStageLeft
	disappear CAMPANULATOWN_SILVER
	setscene SCENE_CAMPANULATOWN_NOTHING
	special HealParty
	playmapmusic
	end
...
CampanulaTown_MapEvents:
	...
	warp_event 21,  9, CHERRYGROVE_POKECENTER_1F, 1
	warp_event 17,  7, CHERRYGROVE_GYM_SPEECH_HOUSE, 1
	warp_event 25,  9, GUIDE_GENTS_HOUSE, 1
	warp_event 31, 11, CHERRYGROVE_EVOLUTION_SPEECH_HOUSE, 1

	def_coord_events
	coord_event 33,  6, SCENE_CAMPANULATOWN_MEET_RIVAL, CherrygroveSilverSceneNorth
	coord_event 33,  7, SCENE_CAMPANULATOWN_MEET_RIVAL, CherrygroveSilverSceneSouth

	def_bg_events
	bg_event 30,  8, BGEVENT_READ, CampanulaTownSign
	bg_event 23,  9, BGEVENT_READ, GuideGentsHouseSign
	bg_event 24,  3, BGEVENT_READ, CampanulaTownMartSign
	bg_event 30,  3, BGEVENT_READ, CampanulaTownPokecenterSign

	def_object_events
	object_event 32,  6, SPRITE_GRAMPS, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, CampanulaTownGuideGent, EVENT_GUIDE_GENT_IN_HIS_HOUSE
	object_event 39,  6, SPRITE_SILVER, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, ObjectEvent, EVENT_RIVAL_CAMPANULA_TOWN
